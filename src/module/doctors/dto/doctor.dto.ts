...
import { IsEnum, IsMobilePhone, IsOptional, IsString, Length, Matches } from "class-validator"
...
export class ScheduleDto {
  ...
  @ApiProperty({
    example: "00:00",
    description: "the input format must be in 24-hour format: 00:00",
  })
  ...
  @ApiProperty({
    example: "30000",
    description: "price must be more than 30000 Toman",
  })
  price: string;
}
